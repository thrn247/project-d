...
"):
        source[-1] = source[-1][:-1] # remove trailing newline from last line
    cells.append({
        "cell_type": "code",
...
add_code("""print("--- PHASE 4: EVALUATION ON TEST SET (WITH THRESHOLD OPTIMIZATION) ---
")
...
add_code("""print("--- PHASE 5: MODEL INTERPRETABILITY (XGBOOST) ---
")
