...
# Using raw strings and splitlines to safely format for Jupyter
c4_source_raw = r"""import time
...
c5_source_raw = r"""# --- 2. Random Forest ---    
print("
...
c7_source_raw = r"""from sklearn.metrics import classification_report, precision_recall_curve, roc_auc_score, auc
import numpy as np
...
c8_source_raw = r"""import matplotlib.pyplot as plt
...
c9_source_raw = r"""from sklearn.metrics import roc_curve, precision_recall_curve, auc
