...
add_markdown("# Stage 2: Predicting Hospital Readmissions
...
c2 = """# 1. Filter: We only care about patients who were admitted
...
# - Drop 'Admitted_Yes_No' because it is now a constant (1 for everyone here)
# - Drop 'Num_Admissions' if it represents future knowledge.
# - KEEP 'Avg_LOS' (Length of Stay) because the length of the initial admission is highly predictive of readmission!
...
c3 = """# Split the data (80% Training, 20% Testing)
...
c4 = """print("--- STEP 1: SMART PREPROCESSING & SCALING ---")
...
c5 = """print("--- PHASE 3: MODEL TRAINING & HYPERPARAMETER TUNING ---")
...
c6 = """print("--- PHASE 4: EVALUATION ON TEST SET (WITH THRESHOLD OPTIMIZATION) ---
")
...
c7 = """# Create a figure with 3 subplots for Confusion Matrices
...
c8 = """print("--- PHASE 5: MODEL INTERPRETABILITY (XGBOOST) ---
")
